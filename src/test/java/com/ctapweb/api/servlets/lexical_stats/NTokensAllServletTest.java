package com.ctapweb.api.servlets.lexical_stats;
...
public class NTokensAllServletTest {
	...
	public NTokensAllServletTest() throws Exception {
		...
		urlPattern = NTokensAllServlet.URL_PATTERN;

		server = new Server(port);
		ServletContextHandler servletContext = 
				new ServletContextHandler(ServletContextHandler.SESSIONS);
		servletContext.setContextPath(contextPath);
		servletContext.addServlet(NTokensAllServlet.class, urlPattern);
	...
	public void testPostPlainText() {
		try {
			...
			int result = responseCollection.getFirstItem().get()
					.getDataAsMap().get("result-value").getValue().get().asNumber().intValue();
