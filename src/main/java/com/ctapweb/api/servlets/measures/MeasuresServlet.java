...
/**
 * Servlet implementation class MeasuresServlet
 */
@WebServlet(description = "for listing all measures", urlPatterns = { "/measures/" })
public class MeasuresServlet extends HttpServlet {
     ...
     */
    public MeasuresServlet() throws ClassNotFoundException, IOException, SQLException {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		logger.info("User calling doGet() in MeasuresServlet...");

		try {
			response.getWriter().append(gson.toJson(measureTableOperations.getAllEntries()));
