...
@WebServlet(description = "Service for calculating corrected Type-Token Ratio",
urlPatterns = { CTTRServlet.URL_PATTERN })
public class CTTRServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/internal/cttr/*";
	public static final String STAT_NAME = "cttr";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double ttr = LexicalCounts.calculateCTTRAllWords(annotation);
