...
@WebServlet(description = "Service for calculating lexical sophistication II",
urlPatterns = { LexicalSophistication_2_Servlet.URL_PATTERN })
public class LexicalSophistication_2_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/lexical_soph_2/*";
	public static final String STAT_NAME = "lexical_soph_2";
	 ...
	 */
	public LexicalSophistication_2_Servlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalSophisticationBNC.getLexicalSoph2(annotation);
