...
@WebServlet(description = "Service for counting the number of numeral/cardinal word types",
urlPatterns = { N_CD_TypesServlet.URL_PATTERN })
public class N_CD_TypesServlet extends HttpServlet {
