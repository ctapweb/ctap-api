...
@WebServlet(description = "Service for counting the adverb types",
urlPatterns = { N_RB_TypesServlet.URL_PATTERN })
public class N_RB_TypesServlet extends HttpServlet {
