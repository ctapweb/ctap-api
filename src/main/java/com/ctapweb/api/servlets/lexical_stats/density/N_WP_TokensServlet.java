...
@WebServlet(description = "Service for counting the number of WH-pronoun tokens",
urlPatterns = { N_WP_TokensServlet.URL_PATTERN })
public class N_WP_TokensServlet extends HttpServlet {
