...
@WebServlet(description = "Service for counting the verb gerund types",
urlPatterns = { N_VBG_TypesServlet.URL_PATTERN })
public class N_VBG_TypesServlet extends HttpServlet {
