...
@WebServlet(description = "Service for counting the number of verb gerund tokens",
urlPatterns = { N_VBG_TokensServlet.URL_PATTERN })
public class N_VBG_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String POS_TAG = "VBG";
