...
@WebServlet(description = "Service for counting the number of modal auxiliary marker types",
urlPatterns = { N_MD_TypesServlet.URL_PATTERN })
public class N_MD_TypesServlet extends HttpServlet {
