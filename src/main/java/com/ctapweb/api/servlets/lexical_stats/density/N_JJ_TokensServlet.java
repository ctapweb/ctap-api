...
@WebServlet(description = "Service for counting the number of adjective tokens",
urlPatterns = { N_JJ_TokensServlet.URL_PATTERN })
public class N_JJ_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_JJ_tokens/*";
	public static final String STAT_NAME = "n_JJ_tokens";
	public static final String POS_TAG = "JJ";
