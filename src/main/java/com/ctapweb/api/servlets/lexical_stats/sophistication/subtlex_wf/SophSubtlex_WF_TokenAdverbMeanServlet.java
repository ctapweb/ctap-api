...
@WebServlet(description = "Service for calculating lexical sophistication with SUBTLEX measure SUBTLEXWF, mean, adverb tokens",
urlPatterns = { SophSubtlex_WF_TokenAdverbMeanServlet.URL_PATTERN })
public class SophSubtlex_WF_TokenAdverbMeanServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/sophistication/subtlex_wf_token_adverb_mean/*";
	public static final String STAT_NAME = "subtlex_wf_token_adverb_mean";
	 ...
	 */
	public SophSubtlex_WF_TokenAdverbMeanServlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalFrequencySUBTLEXus.getSubtlexWFTokenAdverbMean(annotation);
