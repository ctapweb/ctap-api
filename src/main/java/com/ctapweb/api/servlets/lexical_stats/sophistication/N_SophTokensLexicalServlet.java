...
@WebServlet(description = "Service for counting the number of sophisticated lexical tokens",
urlPatterns = { N_SophTokensLexicalServlet.URL_PATTERN })
public class N_SophTokensLexicalServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_soph_tokens_lexical/*";
	public static final String STAT_NAME = "n_soph_tokens_lexical";
	 ...
	 */
	public N_SophTokensLexicalServlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalSophisticationBNC.getNSophTokensLexical(annotation);
