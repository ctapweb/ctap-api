...
@WebServlet(description = "Service for calculating corrected verb sophistication I",
urlPatterns = { CorrectedVerbSophistication_1_Servlet.URL_PATTERN })
public class CorrectedVerbSophistication_1_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/c_verb_soph_1/*";
	public static final String STAT_NAME = "c_verb_soph_1";
	 ...
	 */
	public CorrectedVerbSophistication_1_Servlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalSophisticationBNC.getCorrectedVerbSoph1(annotation);
