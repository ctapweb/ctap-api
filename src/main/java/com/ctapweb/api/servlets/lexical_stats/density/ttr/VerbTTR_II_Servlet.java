...
@WebServlet(description = "Service for calculating verb TTR-II",
urlPatterns = { VerbTTR_II_Servlet.URL_PATTERN })
public class VerbTTR_II_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/verb_ttr_2/*";
	public static final String STAT_NAME = "verb_ttr_2";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double result = LexicalSophisticationBNC.calculateTTR2Verbs(annotation);
