...
@WebServlet(description = "Service for counting the symbol types",
urlPatterns = { N_SYM_TypesServlet.URL_PATTERN })
public class N_SYM_TypesServlet extends HttpServlet {
