...
@WebServlet(description = "Service for calculating number of adjective tokens",
urlPatterns = { N_Adjective_TokensServlet.URL_PATTERN })
public class N_Adjective_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_adjective_tokens/*";
	public static final String STAT_NAME = "n_adjective_tokens";
	 ...
	 */
	public N_Adjective_TokensServlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double result = LexicalSophisticationBNC.getNAdjectiveTokens(annotation);
