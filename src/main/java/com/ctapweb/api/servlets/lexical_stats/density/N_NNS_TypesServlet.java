...
@WebServlet(description = "Service for counting the number of plural noun types",
urlPatterns = { N_NNS_TypesServlet.URL_PATTERN })
public class N_NNS_TypesServlet extends HttpServlet {
