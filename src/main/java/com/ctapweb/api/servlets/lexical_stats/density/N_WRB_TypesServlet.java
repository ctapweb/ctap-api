...
@WebServlet(description = "Service for counting the wh-adverb types",
urlPatterns = { N_WRB_TypesServlet.URL_PATTERN })
public class N_WRB_TypesServlet extends HttpServlet {
