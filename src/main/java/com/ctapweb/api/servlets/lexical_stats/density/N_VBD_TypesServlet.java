...
@WebServlet(description = "Service for counting the past tense verb types",
urlPatterns = { N_VBD_TypesServlet.URL_PATTERN })
public class N_VBD_TypesServlet extends HttpServlet {
