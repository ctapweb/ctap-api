...
@WebServlet(description = "Service for counting the verb past participle types",
urlPatterns = { N_VBN_TypesServlet.URL_PATTERN })
public class N_VBN_TypesServlet extends HttpServlet {
