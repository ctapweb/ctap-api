...
@WebServlet(description = "Service for calculating lexical sophistication with SUBTLEX measure SUBTLEXWF, sd, all tokens",
urlPatterns = { SophSubtlex_WF_TokenAllSDServlet.URL_PATTERN })
public class SophSubtlex_WF_TokenAllSDServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/sophistication/subtlex_wf_token_all_sd/*";
	public static final String STAT_NAME = "subtlex_wf_token_all_sd";
	 ...
	 */
	public SophSubtlex_WF_TokenAllSDServlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalFrequencySUBTLEXus.getSubtlexWFTokenAllSD(annotation);
