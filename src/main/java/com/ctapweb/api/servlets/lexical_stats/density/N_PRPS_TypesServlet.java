...
@WebServlet(description = "Service for counting the possessive personal pronoun types",
urlPatterns = { N_PRPS_TypesServlet.URL_PATTERN })
public class N_PRPS_TypesServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String POS_TAG = "PRP$";
	public static final String URL_PATTERN = "/lexical_stats/density/n_PRPS_types/*";
	public static final String STAT_NAME = "n_PRPS_types";
