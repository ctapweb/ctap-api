...
@WebServlet(description = "Service for calculating lexical sophistication with SUBTLEX measure SUBTLEXWF, mean, lexical types",
urlPatterns = { SophSubtlex_WF_TypeLexicalMeanServlet.URL_PATTERN })
public class SophSubtlex_WF_TypeLexicalMeanServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/sophistication/subtlex_wf_type_lexical_mean/*";
	public static final String STAT_NAME = "subtlex_wf_type_lexical_mean";
	 ...
	 */
	public SophSubtlex_WF_TypeLexicalMeanServlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalFrequencySUBTLEXus.getSubtlexWFTypeLexicalMean(annotation);
