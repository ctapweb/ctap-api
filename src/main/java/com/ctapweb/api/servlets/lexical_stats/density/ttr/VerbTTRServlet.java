...
@WebServlet(description = "Service for calculating verb TTR",
urlPatterns = { VerbTTRServlet.URL_PATTERN })
public class VerbTTRServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/verb_ttr/*";
	public static final String STAT_NAME = "verb_ttr";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double result = LexicalSophisticationBNC.calculateTTRVerbs(annotation);
