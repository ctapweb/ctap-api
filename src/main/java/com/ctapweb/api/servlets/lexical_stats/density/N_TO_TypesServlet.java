...
@WebServlet(description = "Service for counting the infinitive to types",
urlPatterns = { N_TO_TypesServlet.URL_PATTERN })
public class N_TO_TypesServlet extends HttpServlet {
