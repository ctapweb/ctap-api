...
@WebServlet(description = "Service for calculating lexical sophistication with SUBTLEX measure SUBTLEXLog10WF, sd, lexical tokens",
urlPatterns = { SophSubtlex_Log10WF_TokenLexicalSDServlet.URL_PATTERN })
public class SophSubtlex_Log10WF_TokenLexicalSDServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/sophistication/subtlex_log10wf_token_lexical_sd/*";
	public static final String STAT_NAME = "subtlex_log10wf_token_lexical_sd";
	 ...
	 */
	public SophSubtlex_Log10WF_TokenLexicalSDServlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalFrequencySUBTLEXus.getSubtlexLog10WFTokenLexicalSD(annotation);
