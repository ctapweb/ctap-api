...
@WebServlet(description = "Service for calculating adverb sophistication II",
urlPatterns = { AdverbSophistication_2_Servlet.URL_PATTERN })
public class AdverbSophistication_2_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/adverb_soph_2/*";
	public static final String STAT_NAME = "adverb_soph_2";
	 ...
	 */
	public AdverbSophistication_2_Servlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalSophisticationBNC.getAdverbSoph2(annotation);
