...
@WebServlet(description = "Service for counting the comparative adverb types",
urlPatterns = { N_RBR_TypesServlet.URL_PATTERN })
public class N_RBR_TypesServlet extends HttpServlet {
