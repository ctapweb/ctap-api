...
@WebServlet(description = "Service for counting the number of word types in the first 50 word tokens",
urlPatterns = { NTypes50Servlet.URL_PATTERN })
public class NTypes50Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/internal/n_types_50/*";
	public static final String STAT_NAME = "n_types_50";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		int n_tokens_all = LexicalCounts.getWordTypes(annotation, 50).size();
