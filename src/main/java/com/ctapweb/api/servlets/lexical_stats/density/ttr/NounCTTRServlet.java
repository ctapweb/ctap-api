...
@WebServlet(description = "Service for calculating corrected noun TTR",
urlPatterns = { NounCTTRServlet.URL_PATTERN })
public class NounCTTRServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/noun_cttr/*";
	public static final String STAT_NAME = "noun_cttr";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double result = LexicalSophisticationBNC.calculateCTTRNouns(annotation);
