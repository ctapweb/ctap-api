...
@WebServlet(description = "Service for counting the superlative adverb types",
urlPatterns = { N_RBS_TypesServlet.URL_PATTERN })
public class N_RBS_TypesServlet extends HttpServlet {
