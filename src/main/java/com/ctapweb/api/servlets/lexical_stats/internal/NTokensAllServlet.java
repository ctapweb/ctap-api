package com.ctapweb.api.servlets.lexical_stats.internal;

import javax.servlet.annotation.WebServlet;
import javax.servlet.http.HttpServlet;

@WebServlet(description = "Service for counting the number of all tokens, including words, punctuations, and numbers in an input text.",
urlPatterns = { NTokensAllServlet.URL_PATTERN })
public class NTokensAllServlet extends HttpServlet {
//	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/internal/n_tokens_all/*";
//	public static final String STAT_NAME = "n_tokens_all";
//
...
//	private NLPPreProcess nlpPreProcess;
//
//	/**
//	 * @see HttpServlet#HttpServlet()
//	 */
//	public NTokensAllServlet() {
//		super();
//	}
//
//	@Override
...
//
//		//init NLP pipeline
//		nlpPreProcess = new NLPPreProcess("tokenize");
//
//	}
//	/**
...
//
//		Annotation annotation = nlpPreProcess.process(textContent);
//		int n_tokens_all = LexicalCounts.countNTokensAll(annotation);
//
//		//create a result item
//		logger.trace("Analyzed text \"{}\", with result {}.", 
//				textContent.length() > 50 ? textContent.substring(0, 50) + "..." : textContent, n_tokens_all);
...
//				.addProperty(Property.value(ResultItem.KEY_RESULT_VALUE, ValueFactory.createValue(n_tokens_all)))
//				.build();
//
//		return resultItem;
//	}
