...
@WebServlet(description = "Service for counting the number of foreign word tokens",
urlPatterns = { N_FW_TokensServlet.URL_PATTERN })
public class N_FW_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_FW_tokens/*";
	public static final String STAT_NAME = "n_FW_tokens";
	public static final String POS_TAG = "FW";
