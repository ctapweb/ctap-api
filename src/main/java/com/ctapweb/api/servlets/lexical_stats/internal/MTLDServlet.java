...
@WebServlet(description = "Service for calculating MTLD",
urlPatterns = { MTLDServlet.URL_PATTERN })
public class MTLDServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/mtld/*";
	public static final String STAT_NAME = "mtld";
	...
	public void init() throws ServletException {
		...
		//gets a tagger
		tokenizer = NLPPipeLinesManager.getTokenizer();
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		Annotation annotation = tokenizer.process(textContent);
		double result = LexicalCounts.calculateMTLD(annotation);
