...
@WebServlet(description = "Service for counting the number of personal pronoun tokens",
urlPatterns = { N_PRP_TokensServlet.URL_PATTERN })
public class N_PRP_TokensServlet extends HttpServlet {
