...
@WebServlet(description = "Service for calculating mean evenly segmented Type-Token Ratio (10)",
urlPatterns = { MESTTR10Servlet.URL_PATTERN })
public class MESTTR10Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/internal/mesttr_10/*";
	public static final String STAT_NAME = "mesttr_10";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double mesttr = LexicalCounts.calculateMESTTR(annotation, 10);

		//create a result item
		logger.trace("Analyzed text \"{}\", with result {}.", 
				textContent.length() > 50 ? textContent.substring(0, 50) + "..." : textContent, mesttr);
		resultItem = Item.builder()
				...
				.addProperty(Property.value(ResultItem.KEY_RESULT_VALUE, ValueFactory.createValue(mesttr)))
				.build();
