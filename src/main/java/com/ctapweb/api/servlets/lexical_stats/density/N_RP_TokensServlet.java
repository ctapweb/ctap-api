...
@WebServlet(description = "Service for counting the number of particle tokens",
urlPatterns = { N_RP_TokensServlet.URL_PATTERN })
public class N_RP_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String POS_TAG = "RP";
