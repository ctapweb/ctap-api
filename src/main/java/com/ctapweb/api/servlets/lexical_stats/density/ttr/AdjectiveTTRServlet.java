...
@WebServlet(description = "Service for calculating adjective TTR",
urlPatterns = { AdjectiveTTRServlet.URL_PATTERN })
public class AdjectiveTTRServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/adjective_ttr/*";
	public static final String STAT_NAME = "adjective_ttr";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double result = LexicalSophisticationBNC.calculateTTRAdjectives(annotation);
