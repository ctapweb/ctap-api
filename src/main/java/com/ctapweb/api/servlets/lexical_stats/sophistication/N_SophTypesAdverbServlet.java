...
@WebServlet(description = "Service for counting the number of sophisticated adverb types",
urlPatterns = { N_SophTypesAdverbServlet.URL_PATTERN })
public class N_SophTypesAdverbServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_soph_types_adverb/*";
	public static final String STAT_NAME = "n_soph_types_adverb";
	 ...
	 */
	public N_SophTypesAdverbServlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalSophisticationBNC.getNSophTypesAdverb(annotation);
