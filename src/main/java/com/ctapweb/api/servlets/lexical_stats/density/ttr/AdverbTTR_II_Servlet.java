...
@WebServlet(description = "Service for calculating adverb TTR-II",
urlPatterns = { AdverbTTR_II_Servlet.URL_PATTERN })
public class AdverbTTR_II_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/adverb_ttr_2/*";
	public static final String STAT_NAME = "adverb_ttr_2";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double result = LexicalSophisticationBNC.calculateTTR2Adverbs(annotation);
