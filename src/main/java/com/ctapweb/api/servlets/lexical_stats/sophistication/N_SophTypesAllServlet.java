...
@WebServlet(description = "Service for counting the number of sophisticated word types",
urlPatterns = { N_SophTypesAllServlet.URL_PATTERN })
public class N_SophTypesAllServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_soph_types_all/*";
	public static final String STAT_NAME = "n_soph_types_all";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalSophisticationBNC.getNSophTypesAll(annotation);
