...
@WebServlet(description = "Service for counting the number of sophisticated adjective tokens",
urlPatterns = { N_SophTokensAdjectiveServlet.URL_PATTERN })
public class N_SophTokensAdjectiveServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_soph_tokens_adjective/*";
	public static final String STAT_NAME = "n_soph_tokens_adjective";
	 ...
	 */
	public N_SophTokensAdjectiveServlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalSophisticationBNC.getNSophTokensAdjective(annotation);
