...
urlPatterns = { N_SophTokensAdverbServlet.URL_PATTERN })
public class N_SophTokensAdverbServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_soph_tokens_adverb/*";
	public static final String STAT_NAME = "n_soph_tokens_adverb";
	 ...
	 */
	public N_SophTokensAdverbServlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalSophisticationBNC.getNSophTokensAdverb(annotation);
