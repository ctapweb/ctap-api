...
@WebServlet(description = "Service for calculating Type-Token Ratio",
urlPatterns = { TTRServlet.URL_PATTERN })
public class TTRServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/internal/ttr/*";
	public static final String STAT_NAME = "ttr";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double ttr = LexicalCounts.calculateTTR(annotation);
