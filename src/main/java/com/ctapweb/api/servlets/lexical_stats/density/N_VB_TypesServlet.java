...
@WebServlet(description = "Service for counting the base form verb types",
urlPatterns = { N_VB_TypesServlet.URL_PATTERN })
public class N_VB_TypesServlet extends HttpServlet {
