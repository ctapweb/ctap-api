...
@WebServlet(description = "Service for counting the number of numeric tokens",
urlPatterns = { NTokensNumbersServlet.URL_PATTERN })
public class NTokensNumbersServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/internal/n_tokens_numbers/*";
	public static final String STAT_NAME = "n_tokens_numbers";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		int n_tokens_puncts = LexicalCounts.countNTokensNumbers(annotation);

		//create a result item
		logger.trace("Analyzed text \"{}\", with result {}.", 
				textContent.length() > 50 ? textContent.substring(0, 50) + "..." : textContent, n_tokens_puncts);
		resultItem = Item.builder()
				...
				.addProperty(Property.value(ResultItem.KEY_RESULT_VALUE, ValueFactory.createValue(n_tokens_puncts)))
				.build();
