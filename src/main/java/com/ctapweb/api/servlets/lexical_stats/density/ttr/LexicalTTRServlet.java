...
@WebServlet(description = "Service for calculating lexical TTR",
urlPatterns = { LexicalTTRServlet.URL_PATTERN })
public class LexicalTTRServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/lexical_ttr/*";
	public static final String STAT_NAME = "lexical_ttr";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double result = LexicalSophisticationBNC.calculateTTRLexicals(annotation);
