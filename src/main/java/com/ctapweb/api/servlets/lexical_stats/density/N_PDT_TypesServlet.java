...
@WebServlet(description = "Service for counting the pre-determiner types",
urlPatterns = { N_PDT_TypesServlet.URL_PATTERN })
public class N_PDT_TypesServlet extends HttpServlet {
