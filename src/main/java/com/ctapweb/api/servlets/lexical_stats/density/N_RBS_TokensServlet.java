...
@WebServlet(description = "Service for counting the number of superlative adverb tokens",
urlPatterns = { N_RBS_TokensServlet.URL_PATTERN })
public class N_RBS_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String POS_TAG = "RBS";
