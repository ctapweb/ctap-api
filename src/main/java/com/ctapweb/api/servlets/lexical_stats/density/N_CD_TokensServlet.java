...
@WebServlet(description = "Service for counting the number of numeral/cardinal tokens",
urlPatterns = { N_CD_TokensServlet.URL_PATTERN })
public class N_CD_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_CD_tokens/*";
	public static final String STAT_NAME = "n_CD_tokens";
	public static final String POS_TAG = "CD";
