...
@WebServlet(description = "Service for calculating squared adverb TTR",
urlPatterns = { AdverbSTTRServlet.URL_PATTERN })
public class AdverbSTTRServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/adverb_sttr/*";
	public static final String STAT_NAME = "adverb_sttr";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double result = LexicalSophisticationBNC.calculateSTTRAdverbs(annotation);
