...
@WebServlet(description = "Service for calculating number of lexical types",
urlPatterns = { N_Lexical_TypesServlet.URL_PATTERN })
public class N_Lexical_TypesServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_lexical_types/*";
	public static final String STAT_NAME = "n_lexical_types";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double result = LexicalSophisticationBNC.getNLexicalTypes(annotation);
