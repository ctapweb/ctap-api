...
@WebServlet(description = "Service for counting the number of adverb tokens",
urlPatterns = { N_RB_TokensServlet.URL_PATTERN })
public class N_RB_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String POS_TAG = "RB";
