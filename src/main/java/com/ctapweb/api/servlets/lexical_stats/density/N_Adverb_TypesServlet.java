...
urlPatterns = { N_Adverb_TypesServlet.URL_PATTERN })
public class N_Adverb_TypesServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_adverb_types/*";
	public static final String STAT_NAME = "n_adverb_types";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double result = LexicalSophisticationBNC.getNAdverbTypes(annotation);
