...
@WebServlet(description = "Service for counting the number of conjunction/coordinating tokens",
urlPatterns = { N_CC_TokensServlet.URL_PATTERN })
public class N_CC_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_CC_tokens/*";
	public static final String STAT_NAME = "n_CC_tokens";
	public static final String POS_TAG = "CC";
