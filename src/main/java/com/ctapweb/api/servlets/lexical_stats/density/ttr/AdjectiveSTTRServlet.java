...
@WebServlet(description = "Service for calculating squared adjective TTR",
urlPatterns = { AdjectiveSTTRServlet.URL_PATTERN })
public class AdjectiveSTTRServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/adjective_sttr/*";
	public static final String STAT_NAME = "adjective_sttr";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double result = LexicalSophisticationBNC.calculateSTTRAdjectives(annotation);
