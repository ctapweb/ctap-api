package com.ctapweb.api.servlets.lexical_stats.sophistication.subtlex_wf;
...
@WebServlet(description = "Service for calculating lexical sophistication with SUBTLEX measure SUBTLEXWF, mean, adjective tokens",
urlPatterns = { SophSubtlex_WF_TokenAdjectiveMeanServlet.URL_PATTERN })
public class SophSubtlex_WF_TokenAdjectiveMeanServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/sophistication/subtlex_wf_token_adjective_mean/*";
	public static final String STAT_NAME = "subtlex_wf_token_adjective_mean";
	 ...
	 */
	public SophSubtlex_WF_TokenAdjectiveMeanServlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalFrequencySUBTLEXus.getSubtlexWFTokenAdjectiveMean(annotation);
