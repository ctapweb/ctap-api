...
@WebServlet(description = "Service for counting the number of singlar/mass noun tokens",
urlPatterns = { N_NN_TokensServlet.URL_PATTERN })
public class N_NN_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_NN_tokens/*";
	public static final String STAT_NAME = "n_NN_tokens";
	public static final String POS_TAG = "NN";
