...
@WebServlet(description = "Service for counting the number of interjection tokens",
urlPatterns = { N_UH_TokensServlet.URL_PATTERN })
public class N_UH_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String POS_TAG = "UH";
