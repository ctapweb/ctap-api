...
@WebServlet(description = "Service for counting the number of foreign word types",
urlPatterns = { N_FW_TypesServlet.URL_PATTERN })
public class N_FW_TypesServlet extends HttpServlet {
