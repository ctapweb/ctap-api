...
@WebServlet(description = "Service for counting the number of existential there tokens",
urlPatterns = { N_DT_TokensServlet.URL_PATTERN })
public class N_DT_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_EX_tokens/*";
	public static final String STAT_NAME = "n_EX_tokens";
	public static final String POS_TAG = "EX";
