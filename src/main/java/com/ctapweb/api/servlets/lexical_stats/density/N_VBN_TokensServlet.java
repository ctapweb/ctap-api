...
@WebServlet(description = "Service for counting the number of verb past participle tokens",
urlPatterns = { N_VBN_TokensServlet.URL_PATTERN })
public class N_VBN_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String POS_TAG = "VBN";
