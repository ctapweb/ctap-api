...
@WebServlet(description = "Service for counting the number of determiner tokens",
urlPatterns = { N_EX_TokensServlet.URL_PATTERN })
public class N_EX_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_DT_tokens/*";
	public static final String STAT_NAME = "n_DT_tokens";
	public static final String POS_TAG = "DT";
