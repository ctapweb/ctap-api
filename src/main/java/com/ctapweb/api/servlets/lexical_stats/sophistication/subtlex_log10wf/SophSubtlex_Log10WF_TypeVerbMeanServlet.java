...
@WebServlet(description = "Service for calculating lexical sophistication with SUBTLEX measure SUBTLEXLog10WF, mean, verb types",
urlPatterns = { SophSubtlex_Log10WF_TypeVerbMeanServlet.URL_PATTERN })
public class SophSubtlex_Log10WF_TypeVerbMeanServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/sophistication/subtlex_log10wf_type_verb_mean/*";
	public static final String STAT_NAME = "subtlex_log10wf_type_verb_mean";
	 ...
	 */
	public SophSubtlex_Log10WF_TypeVerbMeanServlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalFrequencySUBTLEXus.getSubtlexLog10WFTypeVerbMean(annotation);
