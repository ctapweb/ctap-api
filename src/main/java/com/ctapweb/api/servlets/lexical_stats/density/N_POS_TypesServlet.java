...
@WebServlet(description = "Service for counting the genitive marker types",
urlPatterns = { N_POS_TypesServlet.URL_PATTERN })
public class N_POS_TypesServlet extends HttpServlet {
