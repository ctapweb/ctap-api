...
@WebServlet(description = "Service for calculating noun sophistication II",
urlPatterns = { NounSophistication_2_Servlet.URL_PATTERN })
public class NounSophistication_2_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/noun_soph_2/*";
	public static final String STAT_NAME = "noun_soph_2";
	 ...
	 */
	public NounSophistication_2_Servlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalSophisticationBNC.calculateLexicalSoph2AllWords(annotation);
