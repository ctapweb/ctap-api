...
@WebServlet(description = "Service for counting the verb present tense (not 3rd person singular) types",
urlPatterns = { N_VBP_TypesServlet.URL_PATTERN })
public class N_VBP_TypesServlet extends HttpServlet {
