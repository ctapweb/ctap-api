...
@WebServlet(description = "Service for counting the number of all word types",
urlPatterns = { NTypesNumbersServlet.URL_PATTERN })
public class NTypesNumbersServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/internal/n_types_numbers/*";
	public static final String STAT_NAME = "n_types_numbers";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		int n_tokens_all = LexicalCounts.countNTypesNumbers(annotation);
