...
@WebServlet(description = "Service for calculating adverb TTR",
urlPatterns = { AdverbTTRServlet.URL_PATTERN })
public class AdverbTTRServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/adverb_ttr/*";
	public static final String STAT_NAME = "adverb_ttr";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double result = LexicalSophisticationBNC.calculateTTRAdverbs(annotation);
