...
@WebServlet(description = "Service for counting the number of verb present tense (not 3rd person singular) tokens",
urlPatterns = { N_VBP_TokensServlet.URL_PATTERN })
public class N_VBP_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String POS_TAG = "VBP";
	public static final String URL_PATTERN = "/lexical_stats/density/n_" + POS_TAG + "_tokens/*";
	public static final String STAT_NAME = "n_" + POS_TAG + "_tokens";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double result = LexicalSophisticationBNC.getN_POS_Tokens(annotation, POS_TAG);
