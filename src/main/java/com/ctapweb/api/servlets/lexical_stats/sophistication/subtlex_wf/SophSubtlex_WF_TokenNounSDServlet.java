...
@WebServlet(description = "Service for calculating lexical sophistication with SUBTLEX measure SUBTLEXWF, sd, noun tokens",
urlPatterns = { SophSubtlex_WF_TokenNounSDServlet.URL_PATTERN })
public class SophSubtlex_WF_TokenNounSDServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/sophistication/subtlex_wf_token_noun_sd/*";
	public static final String STAT_NAME = "subtlex_wf_token_noun_sd";
	 ...
	 */
	public SophSubtlex_WF_TokenNounSDServlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalFrequencySUBTLEXus.getSubtlexWFTokenNounSD(annotation);
