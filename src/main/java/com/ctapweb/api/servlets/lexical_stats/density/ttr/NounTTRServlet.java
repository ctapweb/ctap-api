...
@WebServlet(description = "Service for calculating noun TTR",
urlPatterns = { NounTTRServlet.URL_PATTERN })
public class NounTTRServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/noun_ttr/*";
	public static final String STAT_NAME = "noun_ttr";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double result = LexicalSophisticationBNC.calculateTTRNouns(annotation);
