...
@WebServlet(description = "Service for counting the number of genitive marker tokens",
urlPatterns = { N_POS_TokensServlet.URL_PATTERN })
public class N_POS_TokensServlet extends HttpServlet {
