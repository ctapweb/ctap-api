...
@WebServlet(description = "Service for calculating lexical density",
urlPatterns = { LexicalDensityServlet.URL_PATTERN })
public class LexicalDensityServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/lexical_density/*";
	public static final String STAT_NAME = "lexical_density";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double result = LexicalSophisticationBNC.calculateLexicalDensity(annotation);
