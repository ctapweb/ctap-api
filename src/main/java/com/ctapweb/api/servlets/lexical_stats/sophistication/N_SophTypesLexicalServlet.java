...
@WebServlet(description = "Service for counting the number of sophisticated lexical word types",
urlPatterns = { N_SophTypesLexicalServlet.URL_PATTERN })
public class N_SophTypesLexicalServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_soph_types_lexical/*";
	public static final String STAT_NAME = "n_soph_types_lexical";
	 ...
	 */
	public N_SophTypesLexicalServlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalSophisticationBNC.getNSophTypesLexical(annotation);
