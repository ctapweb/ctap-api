...
@WebServlet(description = "Service for counting the number of determiner word types",
urlPatterns = { N_DT_TypesServlet.URL_PATTERN })
public class N_DT_TypesServlet extends HttpServlet {
