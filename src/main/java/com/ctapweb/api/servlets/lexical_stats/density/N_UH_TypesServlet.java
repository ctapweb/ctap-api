...
@WebServlet(description = "Service for counting the interjection types",
urlPatterns = { N_UH_TypesServlet.URL_PATTERN })
public class N_UH_TypesServlet extends HttpServlet {
