...
@WebServlet(description = "Service for calculating number of verb types",
urlPatterns = { N_Verb_TypesServlet.URL_PATTERN })
public class N_Verb_TypesServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_verb_types/*";
	public static final String STAT_NAME = "n_verb_types";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double result = LexicalSophisticationBNC.getNVerbTypes(annotation);
