...
@WebServlet(description = "Service for counting the number of base form verb tokens",
urlPatterns = { N_VB_TokensServlet.URL_PATTERN })
public class N_VB_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String POS_TAG = "VB";
