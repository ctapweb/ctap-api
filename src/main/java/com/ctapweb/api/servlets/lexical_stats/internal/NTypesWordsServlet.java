...
urlPatterns = { NTypesWordsServlet.URL_PATTERN })
public class NTypesWordsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/internal/n_types_all/*";
	public static final String STAT_NAME = "n_types_all";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		int n_tokens_all = LexicalCounts.countNTypesAll(annotation);
