...
@WebServlet(description = "Service for calculating corrected adverb TTR",
urlPatterns = { AdverbCTTRServlet.URL_PATTERN })
public class AdverbCTTRServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/adverb_cttr/*";
	public static final String STAT_NAME = "adverb_cttr";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double result = LexicalSophisticationBNC.calculateCTTRAdverbs(annotation);
