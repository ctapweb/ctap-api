...
@WebServlet(description = "Service for counting the number of comparative adjective tokens",
urlPatterns = { N_JJR_TokensServlet.URL_PATTERN })
public class N_JJR_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_JJR_tokens/*";
	public static final String STAT_NAME = "n_JJR_tokens";
	public static final String POS_TAG = "JJR";
