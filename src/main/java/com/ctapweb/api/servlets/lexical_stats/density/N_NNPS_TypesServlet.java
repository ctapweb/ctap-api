...
@WebServlet(description = "Service for counting the number of plural proper noun types",
urlPatterns = { N_NNPS_TypesServlet.URL_PATTERN })
public class N_NNPS_TypesServlet extends HttpServlet {
