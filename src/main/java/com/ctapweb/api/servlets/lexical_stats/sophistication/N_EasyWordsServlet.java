...
@WebServlet(description = "Service for counting the number of easy word lemmas",
urlPatterns = { N_EasyWordsServlet.URL_PATTERN })
public class N_EasyWordsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_easy_words/*";
	public static final String STAT_NAME = "n_easy_words";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalSophisticationBNC.getNEasyWords(annotation);
