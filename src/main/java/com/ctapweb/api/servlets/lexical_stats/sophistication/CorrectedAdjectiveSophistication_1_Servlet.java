package com.ctapweb.api.servlets.lexical_stats.sophistication;
...
@WebServlet(description = "Service for calculating corrected adjective sophistication I",
urlPatterns = { CorrectedAdjectiveSophistication_1_Servlet.URL_PATTERN })
public class CorrectedAdjectiveSophistication_1_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/c_adjective_soph_1/*";
	public static final String STAT_NAME = "c_adjective_soph_1";
	 ...
	 */
	public CorrectedAdjectiveSophistication_1_Servlet() {
		super();
	}
	...
	public void init() throws ServletException {
		...
		//gets a tagger
		lemmatizer = NLPPipeLinesManager.getLemmatizer();
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		Annotation annotation = lemmatizer.process(textContent);
		double result = LexicalSophisticationBNC.getCorrectedAdjectiveSoph1(annotation);
