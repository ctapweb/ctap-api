...
@WebServlet(description = "Service for counting the number of infinitive marker tokens",
urlPatterns = { N_TO_TokensServlet.URL_PATTERN })
public class N_TO_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String POS_TAG = "TO";
