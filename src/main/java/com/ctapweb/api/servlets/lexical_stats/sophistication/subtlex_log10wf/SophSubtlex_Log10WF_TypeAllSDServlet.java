...
urlPatterns = { SophSubtlex_Log10WF_TypeAllSDServlet.URL_PATTERN })
public class SophSubtlex_Log10WF_TypeAllSDServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/sophistication/subtlex_log10wf_type_all_sd/*";
	public static final String STAT_NAME = "subtlex_log10wf_type_all_sd";
	 ...
	 */
	public SophSubtlex_Log10WF_TypeAllSDServlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalFrequencySUBTLEXus.getSubtlexLog10WFTypeAllSD(annotation);
