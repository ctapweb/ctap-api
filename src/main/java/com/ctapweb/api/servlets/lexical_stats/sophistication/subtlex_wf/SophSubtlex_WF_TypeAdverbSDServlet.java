...
@WebServlet(description = "Service for calculating lexical sophistication with SUBTLEX measure SUBTLEXWF, sd, adverb types",
urlPatterns = { SophSubtlex_WF_TypeAdverbSDServlet.URL_PATTERN })
public class SophSubtlex_WF_TypeAdverbSDServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/sophistication/subtlex_wf_type_adverb_sd/*";
	public static final String STAT_NAME = "subtlex_wf_type_adverb_sd";
	 ...
	 */
	public SophSubtlex_WF_TypeAdverbSDServlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalFrequencySUBTLEXus.getSubtlexWFTypeAdverbSD(annotation);
