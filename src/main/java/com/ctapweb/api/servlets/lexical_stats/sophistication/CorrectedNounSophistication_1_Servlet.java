...
@WebServlet(description = "Service for calculating corrected noun sophistication I",
urlPatterns = { CorrectedNounSophistication_1_Servlet.URL_PATTERN })
public class CorrectedNounSophistication_1_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/c_noun_soph_1/*";
	public static final String STAT_NAME = "c_noun_soph_1";
	 ...
	 */
	public CorrectedNounSophistication_1_Servlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalSophisticationBNC.getCorrectedNounSoph1(annotation);
