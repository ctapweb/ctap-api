...
@WebServlet(description = "Service for counting the number of sophisticated noun types",
urlPatterns = { N_SophTypesNounServlet.URL_PATTERN })
public class N_SophTypesNounServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_soph_types_noun/*";
	public static final String STAT_NAME = "n_soph_types_noun";
	...
	public void init() throws ServletException {
		...
		//gets a tagger
		lemmatizer = NLPPipeLinesManager.getPosTagger();
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalSophisticationBNC.getNSophTypesNoun(annotation);
