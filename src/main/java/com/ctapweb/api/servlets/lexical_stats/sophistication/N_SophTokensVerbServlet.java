...
@WebServlet(description = "Service for counting the number of sophisticated verb tokens",
urlPatterns = { N_SophTokensVerbServlet.URL_PATTERN })
public class N_SophTokensVerbServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_soph_tokens_verb/*";
	public static final String STAT_NAME = "n_soph_tokens_verb";
	 ...
	 */
	public N_SophTokensVerbServlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalSophisticationBNC.getNSophTokensVerb(annotation);
