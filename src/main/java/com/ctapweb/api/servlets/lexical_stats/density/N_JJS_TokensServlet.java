...
@WebServlet(description = "Service for counting the number of superlative adjective tokens",
urlPatterns = { N_JJS_TokensServlet.URL_PATTERN })
public class N_JJS_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_JJS_tokens/*";
	public static final String STAT_NAME = "n_JJS_tokens";
	public static final String POS_TAG = "JJS";
