...
@WebServlet(description = "Service for counting the particle types",
urlPatterns = { N_RP_TypesServlet.URL_PATTERN })
public class N_RP_TypesServlet extends HttpServlet {
