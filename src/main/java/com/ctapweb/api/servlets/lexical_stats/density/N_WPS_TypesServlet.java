...
@WebServlet(description = "Service for counting the possessive wh-pronoun types",
urlPatterns = { N_WPS_TypesServlet.URL_PATTERN })
public class N_WPS_TypesServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String POS_TAG = "WP$";
	public static final String URL_PATTERN = "/lexical_stats/density/n_WPS_types/*";
	public static final String STAT_NAME = "n_WPS_types";
