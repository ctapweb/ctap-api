...
@WebServlet(description = "Service for calculating corrected adverb sophistication I",
urlPatterns = { CorrectedAdverbSophistication_1_Servlet.URL_PATTERN })
public class CorrectedAdverbSophistication_1_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/c_adverb_soph_1/*";
	public static final String STAT_NAME = "c_adverb_soph_1";
	 ...
	 */
	public CorrectedAdverbSophistication_1_Servlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalSophisticationBNC.getCorrectedAdverbSoph1(annotation);
