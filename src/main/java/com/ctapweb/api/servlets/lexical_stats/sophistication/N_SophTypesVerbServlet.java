...
@WebServlet(description = "Service for counting the number of sophisticated verb types",
urlPatterns = { N_SophTypesVerbServlet.URL_PATTERN })
public class N_SophTypesVerbServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_soph_types_verb/*";
	public static final String STAT_NAME = "n_soph_types_verb";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalSophisticationBNC.getNSophTypesVerb(annotation);
