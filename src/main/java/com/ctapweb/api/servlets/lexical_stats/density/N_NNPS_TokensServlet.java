...
@WebServlet(description = "Service for counting the number of plural proper noun tokens",
urlPatterns = { N_NNPS_TokensServlet.URL_PATTERN })
public class N_NNPS_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_NNPS_tokens/*";
	public static final String STAT_NAME = "n_NNPS_tokens";
	public static final String POS_TAG = "NNPS";
