...
@WebServlet(description = "Service for counting the number of WH adverb tokens",
urlPatterns = { N_WRB_TokensServlet.URL_PATTERN })
public class N_WRB_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String POS_TAG = "WRB";
