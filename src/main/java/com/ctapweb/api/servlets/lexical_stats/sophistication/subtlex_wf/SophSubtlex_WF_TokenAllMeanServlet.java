...
@WebServlet(description = "Service for calculating lexical sophistication with SUBTLEX measure SUBTLEXWF, mean, all tokens",
urlPatterns = { SophSubtlex_WF_TokenAllMeanServlet.URL_PATTERN })
public class SophSubtlex_WF_TokenAllMeanServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/sophistication/subtlex_wf_token_all_mean/*";
	public static final String STAT_NAME = "subtlex_wf_token_all_mean";
	 ...
	 */
	public SophSubtlex_WF_TokenAllMeanServlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalFrequencySUBTLEXus.getSubtlexWFTokenAllMean(annotation);
