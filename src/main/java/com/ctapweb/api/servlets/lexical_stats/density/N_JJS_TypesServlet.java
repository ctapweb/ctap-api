...
@WebServlet(description = "Service for counting the number of superlative adjective word types",
urlPatterns = { N_JJS_TypesServlet.URL_PATTERN })
public class N_JJS_TypesServlet extends HttpServlet {
