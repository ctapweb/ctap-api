...
@WebServlet(description = "Service for calculating mean segmented Type-Token Ratio (50)",
urlPatterns = { MSTTR50Servlet.URL_PATTERN })
public class MSTTR50Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/internal/msttr_50/*";
	public static final String STAT_NAME = "msttr_50";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double msttr = LexicalCounts.calculateMSTTR(annotation, 50);

		//create a result item
		logger.trace("Analyzed text \"{}\", with result {}.", 
				textContent.length() > 50 ? textContent.substring(0, 50) + "..." : textContent, msttr);
		resultItem = Item.builder()
				...
				.addProperty(Property.value(ResultItem.KEY_RESULT_VALUE, ValueFactory.createValue(msttr)))
				.build();
