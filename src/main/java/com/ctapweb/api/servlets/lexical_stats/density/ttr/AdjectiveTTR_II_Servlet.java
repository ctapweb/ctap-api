...
@WebServlet(description = "Service for calculating adjective TTR-II",
urlPatterns = { AdjectiveTTR_II_Servlet.URL_PATTERN })
public class AdjectiveTTR_II_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/adjective_ttr_2/*";
	public static final String STAT_NAME = "adjective_ttr_2";
	 ...
	 */
	public AdjectiveTTR_II_Servlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double result = LexicalSophisticationBNC.calculateTTR2Adjectives(annotation);
