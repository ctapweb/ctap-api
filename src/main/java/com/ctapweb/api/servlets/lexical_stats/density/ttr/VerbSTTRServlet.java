...
@WebServlet(description = "Service for calculating squared verb TTR",
urlPatterns = { VerbSTTRServlet.URL_PATTERN })
public class VerbSTTRServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/verb_sttr/*";
	public static final String STAT_NAME = "verb_sttr";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double result = LexicalSophisticationBNC.calculateSTTRVerbs(annotation);
