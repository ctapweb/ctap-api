...
@WebServlet(description = "Service for counting the number of pre-determiner tokens",
urlPatterns = { N_PDT_TokensServlet.URL_PATTERN })
public class N_PDT_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String POS_TAG = "PDT";
