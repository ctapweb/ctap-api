...
@WebServlet(description = "Service for calculating lexical sophistication with SUBTLEX measure SUBTLEXWF, mean, all types",
urlPatterns = { SophSubtlex_WF_TypeAllMeanServlet.URL_PATTERN })
public class SophSubtlex_WF_TypeAllMeanServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/sophistication/subtlex_wf_type_all_mean/*";
	public static final String STAT_NAME = "subtlex_wf_type_all_mean";
	 ...
	 */
	public SophSubtlex_WF_TypeAllMeanServlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalFrequencySUBTLEXus.getSubtlexWFTypeAllMean(annotation);
