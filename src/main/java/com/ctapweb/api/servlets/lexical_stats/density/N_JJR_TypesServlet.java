...
@WebServlet(description = "Service for counting the number of comparative adjective word types",
urlPatterns = { N_JJR_TypesServlet.URL_PATTERN })
public class N_JJR_TypesServlet extends HttpServlet {
