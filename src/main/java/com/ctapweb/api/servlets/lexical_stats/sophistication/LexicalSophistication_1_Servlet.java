...
@WebServlet(description = "Service for calculating lexical sophistication I",
urlPatterns = { LexicalSophistication_1_Servlet.URL_PATTERN })
public class LexicalSophistication_1_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/lexical_soph_1/*";
	public static final String STAT_NAME = "lexical_soph_1";
	 ...
	 */
	public LexicalSophistication_1_Servlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalSophisticationBNC.calculateSophRatioTokensAllWords(annotation);
