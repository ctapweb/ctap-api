...
urlPatterns = { LogTTRServlet.URL_PATTERN })
public class LogTTRServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/internal/log_ttr/*";
	public static final String STAT_NAME = "log_ttr";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double ttr = LexicalCounts.calculateLogTTR(annotation);
