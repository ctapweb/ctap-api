...
@WebServlet(description = "Service for counting the number of sophisticated adjective types",
urlPatterns = { N_SophTypesAdjectiveServlet.URL_PATTERN })
public class N_SophTypesAdjectiveServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_soph_types_adjective/*";
	public static final String STAT_NAME = "n_soph_types_adjective";
	 ...
	 */
	public N_SophTypesAdjectiveServlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalSophisticationBNC.getNSophTypesAdjective(annotation);
