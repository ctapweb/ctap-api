...
@WebServlet(description = "Service for counting the number of preposition word types",
urlPatterns = { N_IN_TypesServlet.URL_PATTERN })
public class N_IN_TypesServlet extends HttpServlet {
