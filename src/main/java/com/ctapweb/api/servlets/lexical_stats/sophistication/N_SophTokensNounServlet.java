...
@WebServlet(description = "Service for counting the number of sophisticated noun tokens",
urlPatterns = { N_SophTokensNounServlet.URL_PATTERN })
public class N_SophTokensNounServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_soph_tokens_noun/*";
	public static final String STAT_NAME = "n_soph_tokens_noun";
	 ...
	 */
	public N_SophTokensNounServlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalSophisticationBNC.getNSophTokensNoun(annotation);
