...
@WebServlet(description = "Service for calculating lexical sophistication with SUBTLEX measure SUBTLEXLog10WF, mean, verb tokens",
urlPatterns = { SophSubtlex_Log10WF_TokenVerbMeanServlet.URL_PATTERN })
public class SophSubtlex_Log10WF_TokenVerbMeanServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/sophistication/subtlex_log10wf_token_verb_mean/*";
	public static final String STAT_NAME = "subtlex_log10wf_token_verb_mean";
	 ...
	 */
	public SophSubtlex_Log10WF_TokenVerbMeanServlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalFrequencySUBTLEXus.getSubtlexLog10WFTokenVerbMean(annotation);
