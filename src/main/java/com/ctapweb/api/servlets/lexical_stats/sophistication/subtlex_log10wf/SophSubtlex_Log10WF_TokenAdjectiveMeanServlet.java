package com.ctapweb.api.servlets.lexical_stats.sophistication.subtlex_log10wf;
...
import com.ctapweb.api.complexity.lexical.external.LexicalFrequencySUBTLEXus;
...
@WebServlet(description = "Service for calculating lexical sophistication with SUBTLEX measure SUBTLEXLog10WF, mean, adjective tokens",
urlPatterns = { SophSubtlex_Log10WF_TokenAdjectiveMeanServlet.URL_PATTERN })
public class SophSubtlex_Log10WF_TokenAdjectiveMeanServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/sophistication/subtlex_log10wf_token_adjective_mean/*";
	public static final String STAT_NAME = "subtlex_log10wf_token_adjective_mean";
	 ...
	 */
	public SophSubtlex_Log10WF_TokenAdjectiveMeanServlet() {
		super();
	}
	 ...
	 * @throws IOException 
	 */
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalFrequencySUBTLEXus.getSubtlexLog10WFTokenAdjectiveMean(annotation);
