...
@WebServlet(description = "Service for counting the number of list item marker types",
urlPatterns = { N_LS_TypesServlet.URL_PATTERN })
public class N_LS_TypesServlet extends HttpServlet {
