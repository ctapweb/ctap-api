...
@WebServlet(description = "Service for calculating adjective sophistication II",
urlPatterns = { AdjectiveSophistication_2_Servlet.URL_PATTERN })
public class AdjectiveSophistication_2_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/adjective_soph_2/*";
	public static final String STAT_NAME = "adjective_soph_2";
	 ...
	 */
	public AdjectiveSophistication_2_Servlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalSophisticationBNC.getAdjectiveSoph2(annotation);
