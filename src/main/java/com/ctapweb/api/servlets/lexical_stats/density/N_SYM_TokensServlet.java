...
@WebServlet(description = "Service for counting the number of symbol tokens",
urlPatterns = { N_SYM_TokensServlet.URL_PATTERN })
public class N_SYM_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String POS_TAG = "SYM";
