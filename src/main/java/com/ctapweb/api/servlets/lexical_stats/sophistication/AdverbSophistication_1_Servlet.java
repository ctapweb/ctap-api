...
@WebServlet(description = "Service for calculating adverb sophistication I",
urlPatterns = { AdverbSophistication_1_Servlet.URL_PATTERN })
public class AdverbSophistication_1_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/adverb_soph_1/*";
	public static final String STAT_NAME = "adverb_soph_1";
	 ...
	 */
	public AdverbSophistication_1_Servlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalSophisticationBNC.getAdverbSoph1(annotation);
