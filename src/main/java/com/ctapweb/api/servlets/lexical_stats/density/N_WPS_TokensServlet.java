...
@WebServlet(description = "Service for counting the number of possesive WH-pronoun tokens",
urlPatterns = { N_WPS_TokensServlet.URL_PATTERN })
public class N_WPS_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String POS_TAG = "WP$";
	public static final String URL_PATTERN = "/lexical_stats/density/n_WPS_tokens/*";
	public static final String STAT_NAME = "n_WPS_tokens";
