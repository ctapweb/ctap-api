...
@WebServlet(description = "Service for calculating corrected adjective TTR",
urlPatterns = { AdjectiveCTTRServlet.URL_PATTERN })
public class AdjectiveCTTRServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/adjective_cttr/*";
	public static final String STAT_NAME = "adjective_cttr";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double result = LexicalSophisticationBNC.getAdjectiveCTTR(annotation);
