...
@WebServlet(description = "Service for calculating lexical sophistication with SUBTLEX measure SUBTLEXWF, mean, adverb types",
urlPatterns = { SophSubtlex_WF_TypeAdverbMeanServlet.URL_PATTERN })
public class SophSubtlex_WF_TypeAdverbMeanServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/sophistication/subtlex_wf_type_adverb_mean/*";
	public static final String STAT_NAME = "subtlex_wf_type_adverb_mean";
	 ...
	 */
	public SophSubtlex_WF_TypeAdverbMeanServlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalFrequencySUBTLEXus.getSubtlexWFTypeAdverbMean(annotation);
