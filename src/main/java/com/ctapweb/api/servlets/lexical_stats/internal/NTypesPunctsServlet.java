...
urlPatterns = { NTypesPunctsServlet.URL_PATTERN })
public class NTypesPunctsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/internal/n_types_puncts/*";
	public static final String STAT_NAME = "n_types_puncts";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		int n_tokens_all = LexicalCounts.countNTypesPuncts(annotation);
