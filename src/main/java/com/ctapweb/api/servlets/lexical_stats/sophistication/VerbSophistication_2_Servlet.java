...
@WebServlet(description = "Service for calculating verb sophistication II",
urlPatterns = { VerbSophistication_2_Servlet.URL_PATTERN })
public class VerbSophistication_2_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/verb_soph_2/*";
	public static final String STAT_NAME = "verb_soph_2";
	 ...
	 */
	public VerbSophistication_2_Servlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalSophisticationBNC.getVerbSoph2(annotation);
