...
@WebServlet(description = "Service for calculating noun sophistication I",
urlPatterns = { NounSophistication_1_Servlet.URL_PATTERN })
public class NounSophistication_1_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/noun_soph_1/*";
	public static final String STAT_NAME = "noun_soph_1";
	 ...
	 */
	public NounSophistication_1_Servlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalSophisticationBNC.getNounSoph1(annotation);
