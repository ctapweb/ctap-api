...
@WebServlet(description = "Service for calculating adjective sophistication I",
urlPatterns = { AdjectiveSophistication_1_Servlet.URL_PATTERN })
public class AdjectiveSophistication_1_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/adjective_soph_1/*";
	public static final String STAT_NAME = "adjective_soph_1";
	 ...
	 */
	public AdjectiveSophistication_1_Servlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalSophisticationBNC.getAdjectiveSoph1(annotation);
