...
@WebServlet(description = "Service for counting the number of adjective word types",
urlPatterns = { N_JJ_TypesServlet.URL_PATTERN })
public class N_JJ_TypesServlet extends HttpServlet {
