...
@WebServlet(description = "Service for counting the number of sophisticated tokens",
urlPatterns = { N_SophTokensAllServlet.URL_PATTERN })
public class N_SophTokensAllServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_soph_tokens_all/*";
	public static final String STAT_NAME = "n_soph_tokens_all";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalSophisticationBNC.countNSophLemmasAllWords(annotation);
