...
@WebServlet(description = "Service for counting the number of preposition tokens",
urlPatterns = { N_IN_TokensServlet.URL_PATTERN })
public class N_IN_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_IN_tokens/*";
	public static final String STAT_NAME = "n_IN_tokens";
	public static final String POS_TAG = "IN";
