...
@WebServlet(description = "Service for counting the number of punctuation tokens",
urlPatterns = { NTokensPunctsServlet.URL_PATTERN })
public class NTokensPunctsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/internal/n_tokens_puncts/*";
	public static final String STAT_NAME = "n_tokens_puncts";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		int n_tokens_puncts = LexicalCounts.countNTokensPuncts(annotation);
