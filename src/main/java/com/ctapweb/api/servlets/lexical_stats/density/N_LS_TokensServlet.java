...
@WebServlet(description = "Service for counting the number of list item marker tokens",
urlPatterns = { N_LS_TokensServlet.URL_PATTERN })
public class N_LS_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_LS_tokens/*";
	public static final String STAT_NAME = "n_LS_tokens";
	public static final String POS_TAG = "LS";
