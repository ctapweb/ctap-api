...
@WebServlet(description = "Service for calculating number of adverb tokens",
urlPatterns = { N_Adverb_TokensServlet.URL_PATTERN })
public class N_Adverb_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_adverb_tokens/*";
	public static final String STAT_NAME = "n_adverb_tokens";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double result = LexicalSophisticationBNC.getNAdverbTokens(annotation);
