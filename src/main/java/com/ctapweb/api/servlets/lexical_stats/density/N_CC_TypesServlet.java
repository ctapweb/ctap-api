...
@WebServlet(description = "Service for counting the number of conjunction/coordinating word types",
urlPatterns = { N_CC_TypesServlet.URL_PATTERN })
public class N_CC_TypesServlet extends HttpServlet {
