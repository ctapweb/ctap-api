...
@WebServlet(description = "Service for calculating number of noun types",
urlPatterns = { N_Noun_TypesServlet.URL_PATTERN })
public class N_Noun_TypesServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_noun_types/*";
	public static final String STAT_NAME = "n_noun_types";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double result = LexicalSophisticationBNC.getNNounTypes(annotation);
