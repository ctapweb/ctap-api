...
@WebServlet(description = "Service for counting the number of singular/mass noun types",
urlPatterns = { N_NN_TypesServlet.URL_PATTERN })
public class N_NN_TypesServlet extends HttpServlet {
