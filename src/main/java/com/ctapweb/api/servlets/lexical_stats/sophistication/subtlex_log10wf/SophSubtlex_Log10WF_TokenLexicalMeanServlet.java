...
@WebServlet(description = "Service for calculating lexical sophistication with SUBTLEX measure SUBTLEXLog10WF, mean, lexical tokens",
urlPatterns = { SophSubtlex_Log10WF_TokenLexicalMeanServlet.URL_PATTERN })
public class SophSubtlex_Log10WF_TokenLexicalMeanServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/sophistication/subtlex_log10wff_token_lexical_mean/*";
	public static final String STAT_NAME = "subtlex_log10wf_token_lexical_mean";
	 ...
	 */
	public SophSubtlex_Log10WF_TokenLexicalMeanServlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalFrequencySUBTLEXus.getSubtlexLog10WFTokenLexicalMean(annotation);
