...
@WebServlet(description = "Service for counting the number of modal auxiliary tokens",
urlPatterns = { N_MD_TokensServlet.URL_PATTERN })
public class N_MD_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_MD_tokens/*";
	public static final String STAT_NAME = "n_MD_tokens";
	public static final String POS_TAG = "MD";
