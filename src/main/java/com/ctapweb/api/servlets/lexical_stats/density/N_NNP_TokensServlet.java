...
@WebServlet(description = "Service for counting the number of proper noun tokens",
urlPatterns = { N_NNP_TokensServlet.URL_PATTERN })
public class N_NNP_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_NNP_tokens/*";
	public static final String STAT_NAME = "n_NNP_tokens";
	public static final String POS_TAG = "NNP";
