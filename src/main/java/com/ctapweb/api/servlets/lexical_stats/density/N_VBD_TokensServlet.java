...
@WebServlet(description = "Service for counting the number of verb past tense tokens",
urlPatterns = { N_VBD_TokensServlet.URL_PATTERN })
public class N_VBD_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String POS_TAG = "VBD";
