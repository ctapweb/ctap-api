...
@WebServlet(description = "Service for counting the number of singular proper noun types",
urlPatterns = { N_NNP_TypesServlet.URL_PATTERN })
public class N_NNP_TypesServlet extends HttpServlet {
