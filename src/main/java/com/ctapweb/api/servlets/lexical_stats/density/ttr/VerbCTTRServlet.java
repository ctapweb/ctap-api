...
@WebServlet(description = "Service for calculating corrected verb TTR",
urlPatterns = { VerbCTTRServlet.URL_PATTERN })
public class VerbCTTRServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/verb_cttr/*";
	public static final String STAT_NAME = "verb_cttr";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double result = LexicalSophisticationBNC.calculateCTTRVerbs(annotation);
