package com.ctapweb.api.servlets.lexical_stats.density.ttr;
...
@WebServlet(description = "Service for calculating modifier variation",
urlPatterns = { ModifierVariationServlet.URL_PATTERN })
public class ModifierVariationServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/modifier_variation/*";
	public static final String STAT_NAME = "modifier_variation";
	 ...
	 */
	public ModifierVariationServlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double result = LexicalSophisticationBNC.calculateModifierVariation(annotation);
