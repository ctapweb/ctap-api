...
@WebServlet(description = "Service for calculating squared noun TTR",
urlPatterns = { NounSTTRServlet.URL_PATTERN })
public class NounSTTRServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/noun_sttr/*";
	public static final String STAT_NAME = "noun_sttr";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double result = LexicalSophisticationBNC.calculateSTTRNouns(annotation);
