...
@WebServlet(description = "Service for counting the number of existential there word types",
urlPatterns = { N_EX_TypesServlet.URL_PATTERN })
public class N_EX_TypesServlet extends HttpServlet {
