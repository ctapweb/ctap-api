...
@WebServlet(description = "Service for counting the number of plural noun tokens",
urlPatterns = { N_NNS_TokensServlet.URL_PATTERN })
public class N_NNS_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String POS_TAG = "NNS";
