...
@WebServlet(description = "Service for counting the wh-pronoun types",
urlPatterns = { N_WP_TypesServlet.URL_PATTERN })
public class N_WP_TypesServlet extends HttpServlet {
