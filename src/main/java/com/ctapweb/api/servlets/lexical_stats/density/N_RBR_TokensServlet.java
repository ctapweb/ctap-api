...
@WebServlet(description = "Service for counting the number of comparative adverb tokens",
urlPatterns = { N_RBR_TokensServlet.URL_PATTERN })
public class N_RBR_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String POS_TAG = "RBR";
