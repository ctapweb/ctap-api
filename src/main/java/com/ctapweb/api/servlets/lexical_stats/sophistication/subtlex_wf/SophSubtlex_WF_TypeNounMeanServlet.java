...
@WebServlet(description = "Service for calculating lexical sophistication with SUBTLEX measure SUBTLEXWF, mean, noun types",
urlPatterns = { SophSubtlex_WF_TypeNounMeanServlet.URL_PATTERN })
public class SophSubtlex_WF_TypeNounMeanServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/sophistication/subtlex_wf_type_noun_mean/*";
	public static final String STAT_NAME = "subtlex_wf_type_noun_mean";
	 ...
	 */
	public SophSubtlex_WF_TypeNounMeanServlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalFrequencySUBTLEXus.getSubtlexWFTypeNounMean(annotation);
