...
@WebServlet(description = "Service for calculating verb sophistication I",
urlPatterns = { VerbSophistication_1_Servlet.URL_PATTERN })
public class VerbSophistication_1_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/verb_soph_1/*";
	public static final String STAT_NAME = "verb_soph_1";
	 ...
	 */
	public VerbSophistication_1_Servlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalSophisticationBNC.getVerbSoph1(annotation);
