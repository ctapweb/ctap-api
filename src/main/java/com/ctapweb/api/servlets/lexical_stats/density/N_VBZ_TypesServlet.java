...
@WebServlet(description = "Service for counting the verb present tense (3rd person singular) types",
urlPatterns = { N_VBZ_TypesServlet.URL_PATTERN })
public class N_VBZ_TypesServlet extends HttpServlet {
