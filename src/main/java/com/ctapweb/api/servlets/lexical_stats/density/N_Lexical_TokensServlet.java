...
@WebServlet(description = "Service for calculating number of lexical tokens",
urlPatterns = { N_Lexical_TokensServlet.URL_PATTERN })
public class N_Lexical_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_lexical_tokens/*";
	public static final String STAT_NAME = "n_lexical_tokens";
	 ...
	 */
	public N_Lexical_TokensServlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double result = LexicalSophisticationBNC.getNLexicalTokens(annotation);
