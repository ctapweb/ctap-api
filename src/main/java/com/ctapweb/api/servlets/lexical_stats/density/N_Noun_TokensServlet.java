...
@WebServlet(description = "Service for calculating number of noun tokens",
urlPatterns = { N_Noun_TokensServlet.URL_PATTERN })
public class N_Noun_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_noun_tokens/*";
	public static final String STAT_NAME = "n_noun_tokens";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double result = LexicalSophisticationBNC.getNNounTokens(annotation);
