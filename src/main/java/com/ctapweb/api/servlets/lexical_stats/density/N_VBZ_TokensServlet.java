...
@WebServlet(description = "Service for counting the number of verb present tense (3rd person singular) tokens",
urlPatterns = { N_VBZ_TokensServlet.URL_PATTERN })
public class N_VBZ_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String POS_TAG = "VBZ";
