...
@WebServlet(description = "Service for counting the number of WH-determiner tokens",
urlPatterns = { N_WDT_TokensServlet.URL_PATTERN })
public class N_WDT_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String POS_TAG = "WDT";
