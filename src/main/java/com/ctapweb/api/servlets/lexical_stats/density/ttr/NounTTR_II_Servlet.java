...
@WebServlet(description = "Service for calculating noun TTR-II",
urlPatterns = { NounTTR_II_Servlet.URL_PATTERN })
public class NounTTR_II_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/noun_ttr_2/*";
	public static final String STAT_NAME = "noun_ttr_2";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double result = LexicalSophisticationBNC.calculateTTR2Nouns(annotation);
