...
@WebServlet(description = "Service for calculating Guiraud's Type-Token Ratio, or Root TTRServlet",
urlPatterns = { GTTRServlet.URL_PATTERN })
public class GTTRServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/internal/gttr/*";
	public static final String STAT_NAME = "gttr";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double ttr = LexicalCounts.calculateGTTRAllWords(annotation);
