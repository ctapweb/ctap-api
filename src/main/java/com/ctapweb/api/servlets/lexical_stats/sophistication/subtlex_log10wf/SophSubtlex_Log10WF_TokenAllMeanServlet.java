...
@WebServlet(description = "Service for calculating lexical sophistication with SUBTLEX measure SUBTLEXLog10WF, mean, all tokens",
urlPatterns = { SophSubtlex_Log10WF_TokenAllMeanServlet.URL_PATTERN })
public class SophSubtlex_Log10WF_TokenAllMeanServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/sophistication/subtlex_log10wff_token_all_mean/*";
	public static final String STAT_NAME = "subtlex_log10wf_token_all_mean";
	 ...
	 */
	public SophSubtlex_Log10WF_TokenAllMeanServlet() {
		super();
	}
