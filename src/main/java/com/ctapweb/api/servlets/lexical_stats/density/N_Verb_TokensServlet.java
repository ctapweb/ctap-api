...
@WebServlet(description = "Service for calculating number of verb tokens",
urlPatterns = { N_Verb_TokensServlet.URL_PATTERN })
public class N_Verb_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_verb_tokens/*";
	public static final String STAT_NAME = "n_verb_tokens";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double result = LexicalSophisticationBNC.getNVerbTokens(annotation);
