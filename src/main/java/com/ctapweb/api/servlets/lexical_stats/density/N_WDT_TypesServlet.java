...
@WebServlet(description = "Service for counting the wh-determiner types",
urlPatterns = { N_WDT_TypesServlet.URL_PATTERN })
public class N_WDT_TypesServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String POS_TAG = "WHD";
