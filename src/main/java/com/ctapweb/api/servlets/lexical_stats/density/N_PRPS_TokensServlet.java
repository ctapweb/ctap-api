...
@WebServlet(description = "Service for counting the number of possesive personal pronoun tokens",
urlPatterns = { N_PRPS_TokensServlet.URL_PATTERN })
public class N_PRPS_TokensServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String POS_TAG = "PRP$";
	public static final String URL_PATTERN = "/lexical_stats/density/n_PRPS_tokens/*";
	public static final String STAT_NAME = "n_PRPS_tokens";
