...
@WebServlet(description = "Service for calculating the bilogarithmic Type-Token Ratio",
urlPatterns = { UberTTRServlet.URL_PATTERN })
public class UberTTRServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/internal/uber_ttr/*";
	public static final String STAT_NAME = "uber_ttr";
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double ttr = LexicalCounts.calculateUberTTR(annotation);
