...
@WebServlet(description = "Service for calculating lexical sophistication with SUBTLEX measure SUBTLEXLog10WF, mean, adverb tokens",
urlPatterns = { SophSubtlex_Log10WF_TokenAdverbMeanServlet.URL_PATTERN })
public class SophSubtlex_Log10WF_TokenAdverbMeanServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/sophistication/subtlex_log10wf_token_adverb_mean/*";
	public static final String STAT_NAME = "subtlex_log10wf_token_adverb_mean";
	 ...
	 */
	public SophSubtlex_Log10WF_TokenAdverbMeanServlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) throws IOException {
		...
		double result = LexicalFrequencySUBTLEXus.getSubtlexLog10WFTokenAdverbMean(annotation);
