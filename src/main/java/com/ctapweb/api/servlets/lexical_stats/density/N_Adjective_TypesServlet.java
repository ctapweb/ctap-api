...
@WebServlet(description = "Service for calculating number of adjective types",
urlPatterns = { N_Adjective_TypesServlet.URL_PATTERN })
public class N_Adjective_TypesServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/lexical_stats/density/n_adjective_types/*";
	public static final String STAT_NAME = "n_adjective_types";
	 ...
	 */
	public N_Adjective_TypesServlet() {
		super();
	}
	...
	private Item runAnalysisAndGetResult(TextTemplate text) {
		...
		double result = LexicalSophisticationBNC.getNAdjectiveTypes(annotation);
