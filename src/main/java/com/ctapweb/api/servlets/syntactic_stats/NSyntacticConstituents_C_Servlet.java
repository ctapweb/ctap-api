package com.ctapweb.api.servlets.syntactic_stats;
...
@WebServlet(description = "Service for counting number of syntactic constituents: Clauses",
urlPatterns = { NSyntacticConstituents_C_Servlet.URL_PATTERN })
public class NSyntacticConstituents_C_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String URL_PATTERN = "/syntactic_stats/n_syn_constituents_clause/*";
	public static final String STAT_NAME = "n_syn_constituents_c";
	 ...
	 */
	public NSyntacticConstituents_C_Servlet() {
		super();
	}
	...
	public void init() throws ServletException {
		...
		//gets a tagger
		parser = NLPPipeLinesManager.getParser();
